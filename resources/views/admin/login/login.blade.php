...
<html id="extr-page">
   <head>
      ...
      <link href="{{asset('admin/plugins/bootstrap/font-awesome.min.css')}}" rel="stylesheet" />
   ...
   <body class="animated fadeInDown">
      ...
      <script src="{{asset('admin/assets/js/bootstrap.min.js')}}"></script>
         <script src="{{asset('admin/login/jquery-migrate-1.2.1.min.js')}}" type="text/javascript"></script>
